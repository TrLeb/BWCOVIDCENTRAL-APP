...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionEt = findViewById(R.id.pDescripEt);
        imageIv = findViewById(R.id.pImageIv);
        uploadBtn = findViewById(R.id.pUploadBtn);

        //getImage from Camera/gallery
            ...
            ref.putFile(Uri.parse(uri))
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            //image upload to db successfull
                                ...
                                ref.child(timestamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                pd.dismiss();
                                                Toast.makeText(AddPostActivity.this, "Post Succesfully Published", Toast.LENGTH_SHORT).show();
                                                //resetViews
                                                titleEt.setText("");
    ...
    private void pickFromCamera() {
        ...
        cv.put(MediaStore.Images.Media.DESCRIPTION, "Temp Defscr");
